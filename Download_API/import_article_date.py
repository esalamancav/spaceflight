...
class Process:      
    ...
    def get_data(date):
        ...
        data_load = []
        get_article = Endpoints.Article(session, date, limit)
...
if __name__ == '__main__':
    ...
    object_name = "raw/Article_" + fecha_actual + ".csv" 

    #max_id = Process.get_id()
    df_api = Process.get_data(fecha_anterior)
    Process.load_s3(df_api, bucket_name, object_name )
    #df_api.to_csv(f"C:/Users/esala/Drive_Esteban/Esteban/Inetum/articulos.csv", index=False)
    #print(df_api.dtypes)
